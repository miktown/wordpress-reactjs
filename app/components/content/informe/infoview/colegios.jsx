...
class InformeColegios extends React.Component {
  ...
  listColegios () {
    ...
    .map(colegio => {
      colegiosOutput.push(<li key={colegio.id}>
    ...
    return <div>
      ...
      <div className='filtersWrap'>
        <div className='filters'>
          <span onClick={this.onClickBtnFilter.bind(this, 'col_privado')} className={this.state.filters.draft ? 'selected' : null}>Privado</span>
          <span onClick={this.onClickBtnFilter.bind(this, 'col_concertado')} className={this.state.filters.procesando ? 'selected' : null}>Concertado</span>
          <span onClick={this.onClickBtnFilter.bind(this, 'col_publico')} className={this.state.filters.sin_stock ? 'selected' : null}>Público</span>
        </div>
      </div>
      <div>
